...
#ifndef SAMRH71_RTEMS_SERIAL_H
#define SAMRH71_RTEMS_SERIAL_H
...
#define Serial_SAMRH71_RTEMS_FIFO_BUFFER_SIZE 256
#define Serial_SAMRH71_RTEMS_RECV_BUFFER_SIZE 256
#define Serial_SAMRH71_RTEMS_ENCODED_PACKET_MAX_SIZE 256
#define Serial_SAMRH71_RTEMS_DECODED_PACKET_MAX_SIZE BROKER_BUFFER_SIZE

#ifndef Serial_SAMRH71_RTEMS_UART_TLS_SIZE
#define Serial_SAMRH71_RTEMS_UART_TLS_SIZE 512
#endif

#define Serial_SAMRH71_RTEMS_STACK_SIZE \
	(1024 > RTEMS_MINIMUM_STACK_SIZE ? 1024 : RTEMS_MINIMUM_STACK_SIZE)
#define Serial_SAMRH71_RTEMS_TASK_BUFFER_SIZE                                \
	(RTEMS_TASK_STORAGE_SIZE(Serial_SAMRH71_RTEMS_STACK_SIZE +           \
					 Serial_SAMRH71_RTEMS_UART_TLS_SIZE, \
				 RTEMS_FLOATING_POINT))

/**
 * @brief Structure for samrh71_rtems_serial driver internal data
 *
 ...
 */
typedef struct {
	Serial_SamRH71_Rtems_Device_T m_device;
	Samrh71RtemsSerial_Uart m_hal_uart;
	Samrh71RtemsSerial_Uart_Config m_hal_uart_config;
	uint8_t m_fifo_memory_block[Serial_SAMRH71_RTEMS_FIFO_BUFFER_SIZE];
	uint8_t m_recv_buffer[Serial_SAMRH71_RTEMS_RECV_BUFFER_SIZE];
	...
	char m_task_buffer[Serial_SAMRH71_RTEMS_TASK_BUFFER_SIZE];
